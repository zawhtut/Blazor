...
{
    internal class BrowserHost : IBrowserHost
    {
        ...
        public BrowserHost(IServiceProvider services, IJSRuntime runtime)
        {
            ...
            try
            {
                ...
                if (startup == null)
                {
                    var message =
                        ...
                        $"Using {nameof(IBrowserHost)} requires a call to {nameof(IBrowserHostBuilder)}.UseBlazorStartup.";
